...
export default function ForgotPasswordCompanyUserForm() {
  ...
  const { execute, status } = useAction(resetCompanyUserAccountPassword, {
    onSuccess(data, input, reset) {
      if (!data) {
        ...
        toast.success("Company User: One Time Pin (OTP) sent successfully.", {
          description: `Password reset instructions sent to your email.`,
        });

        reset();

        updateUserField("role", "Company_User");
