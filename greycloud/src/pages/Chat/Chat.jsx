...
const Chat = () => {
  ...
  //meta title
  document.title = "Chat | Skote React + Laravel 10 Admin And Dashboard Template";
  ...
  const { chats, groups, contacts, messages } = useSelector(chatSelector);
  ...
  const addMessage = (roomId, sender) => {
    ...
    setcurMessage("");
    message.message !== "" && dispatch(onAddMessage(message));
  };
